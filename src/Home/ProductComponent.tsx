    ...
    return (
        <div className="">
            ...
            <section className="max-w-[1300px] mx-auto bg-[#F9FAFB] py-16 px-3">
                ...
                <h1 className="text-black text-[32px] md:text-[40px] font-bold leading-[56px] ">How to get started on FastCash</h1>
            ...
            <div className='bg-black'>
                <section className="max-w-[1300px] pt-20 text-center text-white mx-auto px-4">
                    ...
                    <div className="mt-4 font-normal text-xl leading-8">With zero collaterals, get access to loans unto ₦1,000,000 Naira at affordable interest rate</div>
